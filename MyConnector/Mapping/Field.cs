...
namespace MyConnector.Mapping
{
    public class Field
    {
        ...
        {
            ConsoleCmd("Comparing " + field.Name);
            ...
            if (field.Name.Trim().ToUpper() != Name.Trim().ToUpper())
            {
                ...
                ConsoleCmd(field.Name + " was changed - param Name - " + field.Name + " to " + Name);
            }
            ...
            if (field.Type.Trim().ToUpper() != Type.Trim().ToUpper())
            {
                ...
                fieldAction.Action = ActionType.Update;
                ConsoleCmd(field.Name + " was changed - param Type- " + field.Type + " to " + Type);
            }
            ...
            if (field.AllowNull != AllowNull)
            {
                ...
                fieldAction.Action = ActionType.Update;
                ConsoleCmd(field.Name + " was changed - param AllowNull - " + field.AllowNull.ToString() + " to " + AllowNull.ToString());
            }
            ...
            if (field.Default.Trim().ToUpper() != Default.Trim().ToUpper())
            {
                ...
                fieldAction.Action = ActionType.Update;
                ConsoleCmd(field.Name + " was changed - param Default - " + field.Default + " to " + Default);
            }
            ...
            if (!string.IsNullOrEmpty(field.After) && field.After.Trim() != After.Trim().ToUpper())
            {
                ...
                fieldAction.Action = ActionType.Update;
                ConsoleCmd(field.Name + " was changed - param After - " + field.After + " to " + After);
            }
